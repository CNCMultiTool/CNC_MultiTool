...
#include "../../CNC_MultiTool_GUI/cnc_data.h"
...
QT_MOC_LITERAL(11, 74, 11), // "show_serial"
QT_MOC_LITERAL(12, 86, 6), // "isOpen"
QT_MOC_LITERAL(13, 93, 11) // "show_status"

    },
    "cnc_data\0Log\0\0s\0errorLog\0show_position\0"
    "show_settings\0show_endswitch\0X\0Y\0Z\0"
    "show_serial\0isOpen\0show_status"
};
...
void cnc_data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->show_serial((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->show_status(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cnc_data::show_serial)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (cnc_data::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cnc_data::show_status)) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 5
void cnc_data::show_serial(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
