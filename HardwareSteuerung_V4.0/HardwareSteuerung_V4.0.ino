...
//SD Card Functions
void start_gcode(char fileName[]){
...
int create_file(char fileName[]){
  ...
  GState = GCodeCreate;
  if(myFile){
    Serial.println("create_file: start");
  }else{
    Serial.println("create_file: fail to open");
  }
}
void writeToSD(char* command_line){
  char wort[10];
