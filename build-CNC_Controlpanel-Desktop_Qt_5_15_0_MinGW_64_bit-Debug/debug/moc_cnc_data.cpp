...
QT_MOC_LITERAL(11, 74, 10), // "show_useES"
QT_MOC_LITERAL(12, 85, 5), // "state"
QT_MOC_LITERAL(13, 91, 13) // "show_motorUse"

    },
    "cnc_data\0Log\0\0s\0errorLog\0show_position\0"
    "show_settings\0show_endswitch\0X\0Y\0Z\0"
    "show_useES\0state\0show_motorUse"
};
...
void cnc_data::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->show_useES((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->show_motorUse((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (cnc_data::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cnc_data::show_useES)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (cnc_data::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cnc_data::show_motorUse)) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 5
void cnc_data::show_useES(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 6
void cnc_data::show_motorUse(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
